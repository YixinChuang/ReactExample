...
namespace ReactExample.Ah
{
    /// <summary>
    ///ValidateCode 的摘要描述
    /// </summary>
    public class VC : IHttpHandler, IRequiresSessionState
    {
        ...
        private String GenerateCheckCode(HttpContext context)
        {
            ...
            {
                context.Session[DotWeb.CommSetup.WebSetup.CheckCodeSession] = checkCode;
            }
        ...
        private void CreateCheckCodeImage(string checkCode, HttpContext context)
        {
            ...
            Bitmap image = new Bitmap((int)Math.Ceiling((checkCode.Length * 16.0)), 22);
